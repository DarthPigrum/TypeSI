...
/// @brief If TYPE_SI_DISABLE_CHECKS flag is set all units are defined as their container type
...
/// @brief Implicit constructor from units with same power values but different container type
...
#endif
/// @brief Dimensionless unit for technical purposes with 7 power values set at 0
/// @tparam T Any number type such as float, double or long double used as a container
